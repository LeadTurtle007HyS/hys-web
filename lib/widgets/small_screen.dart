...
class _SmallScreenState extends State<SmallScreen> {
  ...
  _body() {
    ...
    if (countData != null) {
      return countData!.value["app_bar_navigation"][_currentUserId][_currentUserId] ==
              1
          ? OverView()
                  ...
                  : countData!.value["app_bar_navigation"][_currentUserId][_currentUserId] ==
                      ...
                      ? (countData!.value["chat"][_currentUserId]["index"] == 0) &&
                              (countData!.value["app_bar_navigation"]
                                  ...
                                  5)
                          ? AllChatScreen()
                          : countData!.value["chat"][_currentUserId]["index"] ==
                                  1
                              ? ChatScreen(
                                  countData!.value["chat"][_currentUserId]["userdetails"],
                                  countData!.value["chat"][_currentUserId]["chatid"])
